...
P = async function() {
  ...
  _return = (fn, n) => {
    ...
    if (!(fn._index || fn._kv) && typeof fn === 'object' && !Array.isArray(fn) && typeof fn[this.request.method] !== 'function') {
      ...
      return fn;
    } else if (n.indexOf('.') === -1 || n.split('.').pop().indexOf('_') === 0) { // don't wrap top-level or underscored methods
      return fn.bind(this);
    } else {
...
P.hash = async function(msg) {
  var arr, b, buf, len, parts, ref, ref1, ref2, w;
  try {
    if (msg == null) {
...
P.fetch = async function(url, params) {
  var _f, ct, len, r, ref, ref1, res, response, w;
...
P.svc.oaworks.permissions = async function(meta, roruid, getmeta) {
  var _getmeta, _prep, _score, af, altoa, an, cr, cwd, doa, fz, haddoi, i1, inisn, inp, issns, j1, k1, key, l, l1, len, len1, len10, len2, len3, len4, len5, len6, len7, len8, len9, longest, lvs, m1, msgs, n1, o1, oadoi, overall_policy_restriction, p, p1, pb, perms, pisoa, ps, q1, qr, r1, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref19, ref2, ref20, ref21, ref22, ref23, ref24, ref25, ref3, ref4, ref5, ref6, ref7, ref8, ref9, ro, rors, rp, rr, rs, rwd, sn, snak, snkd, tr, uc, vl, w, wp;
  ...
  _prep = async function(rec) {
    var a, d, em, eph, fst, i1, j1, len, len1, len2, ph, pt, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, swaps, w;
    ...
    if (((ref4 = rec.copyright_name) === 'publisher' || ref4 === 'journal') && (cr || meta.doi || ((ref5 = rec.provenance) != null ? ref5.example : void 0))) {
      ...
      if (((cr != null ? cr.assertion : void 0) != null) && cr.assertion.length) {
        ref7 = cr.assertion;
        for (w = 0, len = ref7.length; w < len; w++) {
          a = ref7[w];
    ...
    for (j1 = 0, len2 = ref14.length; j1 < len2; j1++) {
      d = ref14[j1];
      delete rec[d];
    }
    try {
  ...
  if (meta.ror != null) {
    ...
    if (!(rs != null ? (ref6 = rs.hits) != null ? ref6.total : void 0 : void 0)) {
      ...
      if (rwd = wikidata_record.find('snaks.property.exact:"P6782" AND snaks.property.exact:"P17" AND (snaks.value.exact:"' + meta.ror.join(" OR snaks.value.exact:") + '")')) {
        snkd = false;
        ref7 = rwd.snaks;
        for (j1 = 0, len2 = ref7.length; j1 < len2; j1++) {
          snak = ref7[j1];
          if (snkd) {
            break;
            ...
            if (cwd = wikidata_record.get(snak.qid)) {
              ref8 = cwd.snaks;
              for (k1 = 0, len3 = ref8.length; k1 < len3; k1++) {
                sn = ref8[k1];
                if (sn.property === 'P297') {
                  snkd = true;
    ...
    for (l1 = 0, len4 = ref11.length; l1 < len4; l1++) {
      rr = ref11[l1];
      tr = _prep(rr._source);
      tr.score = _score(tr);
      rors.push(tr);
  ...
  if (issns.length || meta.publisher) {
    ...
    if (((ps != null ? (ref12 = ps.hits) != null ? ref12.hits : void 0 : void 0) != null) && ps.hits.hits.length) {
      ref13 = ps.hits.hits;
      for (m1 = 0, len5 = ref13.length; m1 < len5; m1++) {
        p = ref13[m1];
        rp = _prep(p._source);
        rp.score = _score(rp);
  ...
  if (perms.all_permissions.length) {
    ...
    for (n1 = 0, len6 = ref17.length; n1 < len6; n1++) {
      wp = ref17[n1];
        ...
        if (((ref19 = perms.best_permission) != null ? ref19.author_affiliation_requirement : void 0) == null) {
          if (perms.best_permission != null) {
            if (!((ref20 = ro.provenance) != null ? ref20.enforcement_from : void 0) || !meta.published || moment(meta.published, 'YYYY-MM-DD').isAfter(moment(ro.provenance.enforcement_from, 'DD/MM/YYYY'))) {
              ...
              for (p1 = 0, len8 = ref21.length; p1 < len8; p1++) {
                key = ref21[p1];
                ref22 = ro[key];
                for (q1 = 0, len9 = ref22.length; q1 < len9; q1++) {
                  vl = ref22[q1];
                  if (pb[key] == null) {
                    pb[key] = [];
                  }
              ...
              for (r1 = 0, len10 = ref24.length; r1 < len10; r1++) {
                l = ref24[r1];
...
P.svc.oaworks.permission = function(recs = []) {
  var af, an, cids, dt, i1, inaj, j1, k, k1, keys, kn, l, l1, lc, len, len1, len2, len3, len4, len5, m1, name, nd, nid, nk, nps, nr, nv, rcs, ready, rec, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, s, st, w;
  keys = {
  ...
  for (w = 0, len = recs.length; w < len; w++) {
    ...
    for (k in rec) {
      if (keys[k] && (rec[k] != null) && rec[k].length !== 0) {
        ...
        if (k === 'post-printembargo') { // Post-Print Embargo - empty or number of months like 0, 12, 24
          ...
          for (l1 = 0, len4 = ref3.length; l1 < len4; l1++) {
            s = ref3[l1];
            st = s.trim();
    ...
    if (!nr.licence) {
      ref5 = nr.licences;
      for (m1 = 0, len5 = ref5.length; m1 < len5; m1++) {
        l = ref5[m1];
...
P.svc.oaworks.find = async function(options, metadata = {}, content) {
  var _ill, _metadata, _permissions, _searches, bct, bong, dd, dps, len, mct, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, res, uo, w;
  res = {};
...
P.svc.oaworks.citation = function(citation) {
  var a, ak, bt, clc, cn, d, i1, j1, k1, key, l, l1, len, len1, len2, len3, len4, len5, len6, len7, m, m1, ms, n1, o1, p, pbl, pt, pts, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref19, ref2, ref20, ref21, ref22, ref23, ref24, ref25, ref26, ref27, ref28, ref29, ref3, ref30, ref31, ref32, ref33, ref34, ref35, ref36, ref37, ref4, ref5, ref6, ref7, ref8, ref9, res, rmn, rp, rt, sy, w;
  res = {};
  try {
    if (citation == null) {
  ...
  if (typeof citation === 'object') {
    ...
    ref17 = ['title', 'journal'];
    for (w = 0, len = ref17.length; w < len; w++) {
      key = ref17[w];
    ...
    if ((res.year == null) && ((citation.year != null) || (citation.published != null) || (citation.published_date != null))) {
      try {
        ...
        for (i1 = 0, len1 = ref22.length; i1 < len1; i1++) {
          ms = ref22[i1];
          if (ms.length === 4) {
            if (res.year == null) {
              res.year = ms;
    ...
    if ((res.year == null) && (res.published == null)) {
      ...
      for (j1 = 0, len2 = ref23.length; j1 < len2; j1++) {
        p = ref23[j1];
        try {
    ...
    try {
      if ((res.author == null) && ((citation.author != null) || (citation.z_authors != null))) {
        ...
        for (k1 = 0, len3 = ref27.length; k1 < len3; k1++) {
          a = ref27[k1];
          if (typeof a === 'string') {
            res.author.push({
              name: a
    ...
    if (Array.isArray(citation.assertion)) {
      ...
      for (l1 = 0, len4 = ref30.length; l1 < len4; l1++) {
        a = ref30[l1];
    ...
    if (Array.isArray(citation.license)) {
      ...
      for (m1 = 0, len5 = ref32.length; m1 < len5; m1++) {
        l = ref32[m1];
        ...
        try {
          ...
          if (bt.length > 6) {
            if (bt.indexOf(',') !== -1) {
              res.author = [];
              ref37 = bt.split(',');
              for (o1 = 0, len7 = ref37.length; o1 < len7; o1++) {
                ak = ref37[o1];
                res.author.push({
                  name: ak
                });
...
P.svc.oaworks.scrape = async function(content, doi) {
  var cl, cnts, d, i, i1, j1, k, k1, kk, l1, len, len1, len2, len3, len4, m, me, meta, mk, mkp, mls, mm, mr, mstr, my, n, ref, ref1, ref2, str, ud, w;
  meta = {
    doi: doi
  };
...
P.svc.oaworks.ill = async function() { // only worked on POST with optional auth
  var a, atidy, ats, authors, base, config, eml, first, i1, len, len1, m, meta, o, opts, ordered, r, ref, ref1, ref2, ref3, ref4, su, txt, user, vars, w;
  opts = this.params;
  if (this.user) {
    if (opts.from == null) {
...
P.svc.oaworks.ill.openurl = async function() {
  var author, config, d, defaults, k, len, m, nfield, opts, ref, ref1, uid, url, v, w;
...
P._cache = async function(request, response, age = 120) {
  var ck, cu, h, hp, len, ref1, rp, rs, url, w;
...
P.tdm.clean = function(text) {
  var _bad_chars, c, len, re, ref1, ref2, ref3, ref4, ref5, w;
  if (text == null) {
    text = (ref1 = (ref2 = this != null ? (ref3 = this.params) != null ? ref3.clean : void 0 : void 0) != null ? ref2 : this != null ? (ref4 = this.params) != null ? ref4.text : void 0 : void 0) != null ? ref1 : this != null ? (ref5 = this.params) != null ? ref5.q : void 0 : void 0;
  }
  _bad_chars = [
    {
      bad: '‘',
...
P.tdm.occurrence = function(content, sub, overlap) {
  var n, pos, ref1, ref2, ref3, ref4, ref5, ref6, ref7, step;
  if (content == null) {
    content = (ref1 = this != null ? (ref2 = this.params) != null ? ref2.content : void 0 : void 0) != null ? ref1 : this != null ? (ref3 = this.params) != null ? ref3.url : void 0 : void 0;
  }
  if (content.indexOf('http') === 0) {
    content = this.fetch(content);
  }
  if (sub == null) {
    sub = (ref4 = this != null ? (ref5 = this.params) != null ? ref5.sub : void 0 : void 0) != null ? ref4 : this != null ? (ref6 = this.params) != null ? ref6.q : void 0 : void 0;
  }
  if (overlap == null) {
    overlap = this != null ? (ref7 = this.params) != null ? ref7.overlap : void 0 : void 0;
  }
  content += "";
  sub += "";
  if (sub.length <= 0) {
...
P.tdm.levenshtein = function(a, b, lowercase) {
  var c, cost, i, j, m, minimator, n, o, r, ref1, ref2, ref3, ref4;
  if (a == null) {
    a = this != null ? (ref1 = this.params) != null ? ref1.a : void 0 : void 0;
  }
  if (b == null) {
    b = this != null ? (ref2 = this.params) != null ? ref2.b : void 0 : void 0;
  }
  if (lowercase == null) {
    lowercase = (ref3 = this != null ? (ref4 = this.params) != null ? ref4.lowercase : void 0 : void 0) != null ? ref3 : true;
  }
  if (lowercase) {
    a = a.toLowerCase();
    b = b.toLowerCase();
...
P.tdm.hamming = function(a, b, lowercase) {
  var c, diff, k, long, moves, pc, pos, ref1, ref2, ref3, ref4, short, sl, ss;
  if (a == null) {
    a = this != null ? (ref1 = this.params) != null ? ref1.a : void 0 : void 0;
  }
  if (b == null) {
...
P.tdm.extract = function(opts) {
  var lastslash, len, m, match, mopts, mr, parts, ref1, ref2, res, text, w;
  ...
  try {
    text = opts.convert ? P.convert.run((ref1 = opts.url) != null ? ref1 : opts.content, opts.convert, 'txt') : opts.content;
  } catch (error1) {
    text = opts.content;
  }
...
P.tdm.emails = function(opts = {}) {
  var checked, emails, ex, i1, len, len1, pm, pmr, ref1, ref2, ref3, ref4, ref5, ref6, w;
  ...
  for (w = 0, len = ref1.length; w < len; w++) {
    ...
    for (i1 = 0, len1 = ref2.length; i1 < len1; i1++) {
      ...
      if (indexOf.call(checked, pmr) < 0) {
        if (typeof (((ref3 = P.mail) != null ? ref3.validate : void 0) != null) !== 'function' || P.mail.validate(pmr, (ref4 = P.settings.service) != null ? (ref5 = ref4.openaccessbutton) != null ? (ref6 = ref5.mail) != null ? ref6.pubkey : void 0 : void 0 : void 0).is_valid) {
          emails.push(pmr);
        }
      }
      checked.push(pmr);
...
P.auth = async function(key, val) {
  var cookie, eml, ref1, ref2, ref3, ref4, ref5, ref6, restok, resume, uid, upd, user;
  //if key? and val?
  ...
  if ((this.params.access_token == null) || !(user = (await this.oauth()))) {
    ...
    if (!user && ((this.params.resume != null) || this.cookie)) { // accept resume on a header too?
      ...
      if (!(resume = this.params.resume)) { // login by resume token if provided in param or cookie
        ...
        try {
          cookie = JSON.parse(decodeURIComponent(this.cookie).split(((ref1 = (ref2 = (ref3 = S.auth) != null ? (ref4 = ref3.cookie) != null ? ref4.name : void 0 : void 0) != null ? ref2 : S.name) != null ? ref1 : 'n2') + "=")[1].split(';')[0]);
...
P.auth.token = async function(email, from, subject, text, html, template, url) {
  var ref1, ref2, ref3, ref4, ref5, ref6, ref7, sent, token;
  if (email == null) {
    email = (ref1 = this.params.email) != null ? ref1 : '';
  }
  if (from == null) {
    from = (ref2 = (ref3 = S.auth) != null ? ref3.from : void 0) != null ? ref2 : 'nobody@example.com';
  }
  if (subject == null) {
    subject = (ref4 = (ref5 = S.auth) != null ? ref5.subject : void 0) != null ? ref4 : 'Please complete your login';
  }
  token = this.uid(8);
  if (url == null) {
    url = ((ref6 = (ref7 = this.params.url) != null ? ref7 : this.request.url) != null ? ref6 : 'https://example.com').split('?')[0].replace('/token', '') + '?token=' + token;
  }
...
P.auth.role = function(grl, uid) {
  var cascade, g, group, i1, len, len1, ref1, ref2, ref3, ref4, ref5, ri, rl, role, user, w;
  if (grl == null) {
    grl = this.params.role;
  }
  if ((grl == null) && typeof ((ref1 = this.opts) != null ? ref1.auth : void 0) === 'string') {
    grl = this.opts.auth;
  }
  if (uid == null) {
    uid = this.user;
  ...
  user = (uid != null) && uid !== ((ref2 = this.user) != null ? ref2._id : void 0) ? this.user(uid) : this.user;
  ...
  for (w = 0, len = grl.length; w < len; w++) {
    ...
    if (indexOf.call((ref3 = user.roles.__global__) != null ? ref3 : [], 'root') >= 0) {
      return 'root';
    }
    if (indexOf.call((ref4 = user.roles[group]) != null ? ref4 : [], role) >= 0) {
      return role;
    }
...
P.auth.roles = async function(user, grl, keep) {
  var base1, group, ref1, ref2, ref3, role;
  if (user == null) {
    user = (ref1 = this.user) != null ? ref1 : this.params.roles;
  }
  ...
  if ((ref2 = indexOf.call((ref3 = user.roles) != null ? ref3[group] : void 0, role) >= 0) != null ? ref2 : []) {
    if (keep != null) {
      user.roles[group].splice(user.roles[group].indexOf(role), 1);
      return this.kv('user/' + user._id, user);
    }
  } else {
    if ((base1 = user.roles)[group] == null) {
      base1[group] = [];
    }
...
P.oauth = async function(token, cid) {
  var ref1, ref10, ref11, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, ret, sets, uid, user, validate;
  ...
  if (token) {
    try {
      ...
      if (cid == null) {
        cid = (ref1 = (ref2 = S.svc[(ref3 = this.params.service) != null ? ref3 : 'z']) != null ? (ref4 = ref2.google) != null ? (ref5 = ref4.oauth) != null ? (ref6 = ref5.client) != null ? ref6.id : void 0 : void 0 : void 0 : void 0) != null ? ref1 : (ref7 = S.use) != null ? (ref8 = ref7.google) != null ? (ref9 = ref8.oauth) != null ? (ref10 = ref9.client) != null ? ref10.id : void 0 : void 0 : void 0 : void 0;
      }
      if ((cid != null) && ((ref11 = validate.data) != null ? ref11.aud : void 0) === cid) {
...
P.auth._insert = async function(key, val) {
  var em, first, ref1, ref2, res, u, user;
  if (typeof key === 'string' && (val != null)) {
    if (val === '') {
      if (key.startsWith('user/')) {
        key = key.replace('user/', '');
      }
      user = ((ref1 = this.user) != null ? ref1._id : void 0) === key ? this.user : (await this.kv('user/' + key));
      try {
    ...
    if ((key == null) && (this != null ? (ref2 = this.user) != null ? ref2._id : void 0 : void 0)) {
...
P.status = function() {
  ...
  if (S.dev) {
    ref1 = ['id', 'request', 'params', 'parts', 'opts', 'headers', 'cookie', 'user', 'fn', 'routes'];
    for (w = 0, len = ref1.length; w < len; w++) {
      k = ref1[w];
      try {
        if (res[k] == null) {
...
P.src.google = async function(q, id, key) {
  var ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, url;
  if (q == null) {
    q = (ref1 = this != null ? (ref2 = this.params) != null ? ref2.q : void 0 : void 0) != null ? ref1 : this != null ? (ref3 = this.params) != null ? ref3.google : void 0 : void 0;
  }
  if (id == null) {
    id = (ref4 = S.src.google) != null ? (ref5 = ref4.secrets) != null ? (ref6 = ref5.search) != null ? ref6.id : void 0 : void 0 : void 0;
  }
  if (key == null) {
    key = (ref7 = S.src.google) != null ? (ref8 = ref7.secrets) != null ? (ref9 = ref8.search) != null ? ref9.key : void 0 : void 0 : void 0;
  }
  if (q && id && key) {
...
P.src.google.sheets = async function(opts) {
  var g, k, l, ref1, ref2, url, val, values;
  ...
  if (((opts.sheets != null) || (opts.sheet != null)) && (opts.sheetid == null)) {
    opts.sheetid = (ref2 = opts.sheet) != null ? ref2 : opts.sheets;
    delete opts.sheet;
    delete opts.sheets;
  }
  values = [];
...
P.src.google.chat = function(params, url) {
  var data, headers, ref1, ref2, ref3, ref4, ref5;
  if (params == null) {
    params = this.params;
  }
  headers = {
  ...
  data = {
    ...
    headers: headers,
    body: {
      text: decodeURIComponent((ref1 = (ref2 = (ref3 = params.text) != null ? ref3 : params.msg) != null ? ref2 : params.body) != null ? ref1 : '')
    }
  };
  if (url == null) {
    url = (ref4 = this.S.src.google) != null ? (ref5 = ref4.secrets) != null ? ref5.chat : void 0 : void 0; // should url be allowed on params? doesn't strictly need to be secret, the key and token it uses only work for the webhook
  }
...
P.src.microsoft.bing = async function(q, key) {
  var ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, res, url;
  if (q == null) {
    q = (ref1 = (ref2 = this != null ? (ref3 = this.params) != null ? ref3.bing : void 0 : void 0) != null ? ref2 : this != null ? (ref4 = this.params) != null ? ref4.q : void 0 : void 0) != null ? ref1 : this != null ? (ref5 = this.params) != null ? ref5.query : void 0 : void 0;
  }
  if (key == null) {
    key = (ref6 = S.src.microsoft) != null ? (ref7 = ref6.secrets) != null ? (ref8 = ref7.bing) != null ? ref8.key : void 0 : void 0 : void 0;
  }
  ...
  if (res != null ? (ref9 = res.webPages) != null ? ref9.value : void 0 : void 0) {
    return {
...
P.src.microsoft.graph = function(q) {
  var _append, longest, lvs, paper, ref1, ref2, ref3, ref4, res, rt, title;
  ...
  if (q == null) {
    q = (ref1 = (ref2 = (ref3 = this.params.graph) != null ? ref3 : this.params.doi) != null ? ref2 : this.params.title) != null ? ref1 : this.params;
  }
  ...
  if (typeof q === 'string' && q.indexOf('/') !== -1 && q.indexOf('10.') === 0 && (paper = this.src.microsoft.graph.paper('Doi.exact:"' + q + '"'))) {
    ...
    if (res = this.src.microsoft.graph.paper('PaperTitle:"' + title + '"')) {
      ...
      if (typeof (this != null ? (ref4 = this.tdm) != null ? ref4.levenshtein : void 0 : void 0) === 'function') {
...
P.src.oadoi = function(doi) {
  var ref1, ref2, ref3, url;
  if (doi == null) {
    doi = (ref1 = this != null ? (ref2 = this.params) != null ? ref2.oadoi : void 0 : void 0) != null ? ref1 : this != null ? (ref3 = this.params) != null ? ref3.doi : void 0 : void 0;
  }
...
if ((base2 = S.mail).from == null) {
  base2.from = "alert@cottagelabs.com";
}

if ((base3 = S.mail).to == null) {
  base3.to = "mark@cottagelabs.com";
}

if ((base4 = S.src).google == null) {
  base4.google = {};
}
