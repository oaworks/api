...
P.src.zenodo.deposition.create = (metadata, up, token, dev) ->
  ...
  if up?
    rs = await @fetch url, method: 'POST', body: data, headers: referer: 'https://oa.works'
    ...
    return await @fetch url, method: 'POST', body: data, headers: referer: 'https://oa.works'
...
P.src.zenodo.deposition.upload = (id, content, file, filename, url, token, dev) ->
  ...
  if url and not content and not file
    try content = await @fetch url, buffer: true, headers: referer: 'https://oa.works'
  token ?= @params.token
  ...
  return @fetch url, file: (content ? file), filename: filename, headers: referer: 'https://oa.works'
...
P.src.zenodo.deposition.publish = (id, token, dev) ->
  ...
  return @fetch url, method: 'POST', headers: referer: 'https://oa.works'
...
P.src.zenodo.deposition.delete = (id, token, dev) ->
  ...
  await @fetch url, method: 'DELETE', headers: referer: 'https://oa.works'
  return true
